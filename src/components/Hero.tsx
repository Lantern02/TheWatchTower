...
const Hero = () => {
  return (
    <section className="relative bg-gradient-to-br from-warm-50 via-warm-100 to-warm-200 py-24 md:py-32 overflow-hidden">
      {/* Background decoration */}
      <div className="absolute inset-0 opacity-10">
        <div className="absolute top-20 left-10 w-32 h-32 border border-warm-400 rounded-full"></div>
        <div className="absolute bottom-20 right-10 w-24 h-24 border border-warm-400 rounded-full"></div>
        <div className="absolute top-1/2 left-1/4 w-16 h-16 border border-warm-400 rounded-full"></div>
      </div>
      ...
      <div className="max-w-5xl mx-auto px-6 text-center relative z-10">
        <div className="animate-fade-in">
          ...
          <div className="flex justify-center items-center gap-4 mb-8">
            ...
            <Feather className="h-10 w-10 text-warm-600" />
            <Eye className="h-11 w-11 text-warm-700" />
          </div>
          
          <h1 className="font-serif text-5xl md:text-7xl font-bold text-primary mb-6 leading-tight">
            The<span className="text-warm-700">Watch</span>Tower
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-8">
            <Link 
              to="/blog" 
              className="group bg-primary text-primary-foreground px-10 py-4 rounded-xl hover:bg-warm-800 transition-all duration-300 font-medium text-lg shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
